...
class ChatRepository {
  ...
  Future<Message> sendMessage({required Map<String, dynamic> parameter}) async {
    try {
      if (kDebugMode) {
  ...
  Future<void> makeMeOnline() async {
    try {
      var result = await ApiBaseHelper().postAPICall(makeMeOnlineApi, {});
