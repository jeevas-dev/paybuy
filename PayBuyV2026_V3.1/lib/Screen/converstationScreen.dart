      ...
      if (widget.isGroup) {
        ...
        if (widget.personalChatHistory?.getUnreadMessage(
          ...
          context.read<PersonalConverstationsCubit>().updatePersonalChatHistory(
            personalChatHistory: widget.personalChatHistory!.copyWith(
              unreadMsg: '0',
            ),
          );
        }
  ...
  Widget _buildAttachments() {
    return files.isEmpty
        ...
        : Container(
            ...
            child: Column(
              children: List.generate(files.length, (index) => index).map((
                index,
              ) {
          ...
          BlocConsumer<SendMessageCubit, SendMessageState>(
            listener: (context, state) {
              if (state is SendMessageSuccess) {
                ...
                context.read<ConverstationCubit>().addMessage(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [widget.isGroup ? _buildGroupInfoButton() : const SizedBox()],
        leading: Builder(
                    ...
                    ? Align(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            color: Theme.of(
                              context,
                            ).colorScheme.white.withValues(alpha: 0.9),
                          ),
