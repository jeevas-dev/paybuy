...
class OrderSummery extends StatelessWidget {
  ...
  OrderSummery({super.key, required this.cartList});
  @override
  Widget build(BuildContext context) {
    print("deliveryCharge----> ${context.read<CartProvider>().deliveryCharge}");
    return Card(
      elevation: 1,
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              '${'ORDER_SUMMARY'.translate(context: context)} (${cartList.length} items)',
              style: TextStyle(
            ...
            if (IS_SHIPROCKET_ON == '1' &&
              ...
              Row(
                ...
                children: [
                  Text(
                    'DELIVERY_DAY_LBL'.translate(context: context),
                    style: TextStyle(
                        color: Theme.of(context).colorScheme.lightBlack2),
                  ),
                  Text(
