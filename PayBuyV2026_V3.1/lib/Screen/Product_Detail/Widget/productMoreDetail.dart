...
class ProductMoreDetail extends StatelessWidget {
  Product? model;
  Function update;
  ProductMoreDetail({super.key, this.model, required this.update});

  Widget _desc(Product? model, BuildContext context) {
  ...
  Widget _madeIn(Product? model, BuildContext context) {
    ...
    return madeIn != '' && madeIn!.isNotEmpty
        ? Padding(
            ...
            child: ListTile(
              ...
              dense: true,
              title: Text(
                'MADE_IN'.translate(context: context),
                style: Theme.of(context).textTheme.titleSmall,
              ),
            ),
          )
  ...
  Widget build(BuildContext context) {
    return model!.attributeList!.any((e) => e.id!.isNotEmpty) ||
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Product Details'.translate(context: context),
                          style: TextStyle(
                        ...
                        if (model!.attributeList!.any(
                          (e) =>
                              e.id!.length <= 5 ||
                              (model!.desc!.length <= 5) ||
                              model!.madein!.length <= 5,
                        ))
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              InkWell(
                                child: Text(
                                  !context.read<ProductDetailProvider>().seeView
                                      ? 'See Less'.translate(context: context)
                                      : 'See More'.translate(context: context),
