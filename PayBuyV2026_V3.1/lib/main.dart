...
void main() async {
  ...
  if (kReleaseMode) {
    ErrorWidget.builder = (FlutterErrorDetails flutterErrorDetails) =>
        Center(child: Text(flutterErrorDetails.toString()));
  }
  initializedDownload();
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider<SettingProvider>(create: (context) => SettingProvider(prefs)),
        ...
        BlocProvider<CountryCodeCubit>(create: (context) => CountryCodeCubit()),
    ...
    SystemChrome.setSystemUIOverlayStyle(
      SystemUiOverlayStyle(
        statusBarColor: Theme.of(
          context,
        ).colorScheme.lightWhite, // Change to your desired color
          ...
          (
            ...
            child: MaterialApp(
              ...
              theme: ThemeData(
                ...
                iconTheme: Theme.of(
                  context,
                ).iconTheme.copyWith(color: colors.primary),
                primarySwatch: colors.primary_app,
              ...
              darkTheme: ThemeData(
                ...
                iconTheme: Theme.of(
                  context,
                ).iconTheme.copyWith(color: colors.secondary),
                textTheme: TextTheme(
                  titleLarge: TextStyle(
                    color: Theme.of(context).colorScheme.fontColor,
                    fontWeight: FontWeight.w600,
